...
public class FuncionarioDataSource {
	...
	public static void criarLista() {
		listaFuncionarios.add(new Funcionario(100, "Lucas", 2000.0, 4));
		listaFuncionarios.add(new Funcionario(101, "Mateus", 2400.0, 2));
		listaFuncionarios.add(new Funcionario(102, "Margarete", 14000.0, 2));
		listaFuncionarios.add(new Funcionario(103, "luciana", 2600.0, 1));
	}
